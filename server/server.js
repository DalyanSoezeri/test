...
app.get('/editvoca', function(req, res){
    res.render('EditVoca')
})

app.get('/edithandout', function(req, res){
      ...
      console.log(params)
        ...
        for(var i = 0; i < games.games.length; i++){
            ...
            if(params.pin == games.games[i].pin){
                ...
                io.emit('updatePlayerLobby', playersInGame);//Sending host player data to display//.to(`${params.pin}`)
